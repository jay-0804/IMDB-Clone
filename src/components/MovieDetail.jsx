    ...
    return (
      <div className="min-h-screen bg-zinc-900 flex items-center justify-center">
        <div className="text-center text-white">
          <p className="text-xl">Failed to load movie</p>
          <Link to="/movies" className="mt-4 inline-block text-yellow-400 hover:underline">Back to Movies</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 -mt-32 relative z-10 pb-16">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 text-white">
            ...
            {movie.tagline && (
              <p className="text-yellow-400/90 italic mb-4">&ldquo;{movie.tagline}&rdquo;</p>
            )}
